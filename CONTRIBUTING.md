...
`ama_archiver` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/ama_archiver
[issue tracker]: https://github.com/<USERNAME>/ama_archiver/issues
